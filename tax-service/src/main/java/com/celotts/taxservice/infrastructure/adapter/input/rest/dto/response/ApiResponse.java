...
public record ApiResponse<T>(
    ...
    public static <T> ApiResponse<T> ok(T data, String message) {
        return new ApiResponse<>(200, message, Instant.now(), data, null, null, null, null, null);
    }
    ...
    public static <T> ApiResponse<T> created(T data, String message) {
        return new ApiResponse<>(201, message, Instant.now(), data, null, null, null, null, null);
    }
    ...
    public static <T> ApiResponse<List<T>> okList(List<T> list, String message) {
        return new ApiResponse<>(200, message, Instant.now(), list, (long) list.size(), null, null, null, null);
    }

    public static <T> ApiResponse<T> accepted(T data) {
        return new ApiResponse<>(202, "Accepted", Instant.now(), data, null, null, null, null, null);
    }
    ...
    public static <T> ApiResponse<T> unauthorized(String message, String path, String method) {
        return error(401, message, path, method, "ERR_UNAUTHORIZED", null);
    }
    ...
    public static <T> ApiResponse<T> unprocessableEntity(String message, String path, String method, List<Violation> errors) {
        return error(422, message, path, method, "ERR_UNPROCESSABLE_ENTITY", errors);
    }
    ...
    public record Violation(
        ...
        public static Violation of(String field, String message, Object rejectedValue) {
            return new Violation(field, message, rejectedValue);
        }
    }
}