...
DB_USER=${SUPPLIER_DB_USERNAME}
DB_PASS=${SUPPLIER_DB_PASSWORD}
...
# CORRECCIÓN: Usamos la variable de entorno $WAIT_TIMEOUT (que vale 300)
$WAIT_FOR_IT $DB_HOST -t ${WAIT_TIMEOUT} -- echo "Base de datos OK."
