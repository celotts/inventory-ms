...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(
        ...
        // Puedes ajustar esto a tus columnas más sensibles
        if (rawMessage != null && rawMessage.contains("product_type")) {
            customMessage = "El campo obligatorio 'product_type' no puede estar vacío.";
        }
